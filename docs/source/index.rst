...
**What is the Application:** Wasteaway is a mobile application that allows the user first to create an account connecting to the database. Once the account is created and all the details are validated. The user will be able to grant access to the application. When the user enters the homepage, there will be an introduction video directing the user on how to navigate through the pages. 
